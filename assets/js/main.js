...
skillsButton.addEventListener('click', (e) => {
  ...
  if (skillsSection.classList.contains("show"))
    skillsButton.innerText = "Voir Plus"
  else skillsButton.innerText = "Voir Moins"
...
educationAwardButton.addEventListener('click', (e) => {
  e.preventDefault();
  if (educationAwardButton.innerText == "Voir Plus") {
    educationAward.classList.add('show');
    educationAwardButton.innerText = "Voir Moins"
  } else {
    educationAward.classList.remove('show');
    educationAwardButton.innerText = "Voir Plus"
  }
})
